...
>
  My Account
      ...
      <div className="col-span-3 ml-20">
        {activeSub === "general" && (
          <div>
            <h3 className="text-lg font-medium mb-4 text-blue-500 border-b border-gray-200 pb-2 w-full">My Account</h3>
          ...
          <input
            type="username"
            placeholder="{usr_username}"
            className="w-full rounded-md border border-gray-300 px-2 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
